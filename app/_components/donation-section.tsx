    ...
    <main className="flex flex-col items-center justify-center p-4 md:p-8 gap-8 bg-gradient-to-b from-gray-50 to-white">
      ...
      <div className="w-full max-w-6xl overflow-hidden" ref={emblaRef}>
        <div className="flex">
          {donations.map((donation) => (
            <div key={donation.id} className="flex-[0_0_100%] min-w-0 sm:flex-[0_0_50%] lg:flex-[0_0_33.33%] px-2">
              <Card className="h-full flex flex-col">
                ...
                <div className="h-2 w-full bg-gray-100 rounded-full overflow-hidden">
                     <div
                        ...
                        style={{
                          width: `${(donation.totalRaised / donation.fundRequired) * 100}%`,
                        }}  
                  />
                </div>
                ...
                <CardFooter className="p-4 pt-0 flex gap-2 justify-between items-center">
                  <Button
                    className="flex-grow bg-[#E84C3D] hover:bg-[#E84C3D]/90"
      ...
      <Dialog open={!!selectedDonation} onOpenChange={() => setSelectedDonation(null)}>
        <DialogContent>
          ...
          <DialogFooter>
            <Button type="submit" className="bg-[#E84C3D] hover:bg-[#E84C3D]/90">
              Donate
            </Button>
          </DialogFooter>
        </DialogContent>
